...
bool ShopLayer::init()
{
	...
	do
	{
		...
		MenuItem* shoes = MenuItemImage::create("equipment/shensuzhixve.jpg", "equipment/shensuzhixve.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		...
		MenuItem* attack1 = MenuItemImage::create("equipment/tiejian.jpg", "equipment/tiejian.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack1->setScale(0.2f); attack1->setTag(2); attack1->setPosition(35 * winSize.width / 100, 95 * winSize.height / 100);

		MenuItem* attack2 = MenuItemImage::create("equipment/bishou.jpg", "equipment/bishou.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack2->setScale(0.2f); attack2->setTag(3); attack2->setPosition(45 * winSize.width / 100, 95 * winSize.height / 100);

		MenuItem* attack3 = MenuItemImage::create("equipment/bojiquantao.jpg", "equipment/bojiquantao.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack3->setScale(0.2f); attack3->setTag(4); attack3->setPosition(55 * winSize.width / 100, 95 * winSize.height / 100);

		MenuItem* attack4 = MenuItemImage::create("equipment/fengbaojujian.jpg", "equipment/fengbaojujian.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack4->setScale(0.2f); attack4->setTag(5); attack4->setPosition(35 * winSize.width / 100, 85 * winSize.height / 100);

		MenuItem* attack5 = MenuItemImage::create("equipment/kuangbaoshuangren.jpg", "equipment/kuangbaoshuangren.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack5->setScale(0.2f); attack5->setTag(6); attack5->setPosition(45 * winSize.width / 100, 85 * winSize.height / 100);

		MenuItem* attack6 = MenuItemImage::create("equipment/sujizhiqiang.jpg", "equipment/sujizhiqiang.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack6->setScale(0.2f); attack6->setTag(7); attack6->setPosition(55 * winSize.width / 100, 85 * winSize.height / 100);

		MenuItem* attack7 = MenuItemImage::create("equipment/anyingzhanfu.jpg", "equipment/anyingzhanfu.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack7->setScale(0.2f); attack7->setTag(8); attack7->setPosition(35 * winSize.width / 100, 75 * winSize.height / 100);

		MenuItem* attack8 = MenuItemImage::create("equipment/poxiao.jpg", "equipment/poxiao.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		attack8->setScale(0.2f); attack8->setTag(9); attack8->setPosition(45 * winSize.width / 100, 75 * winSize.height / 100);

		MenuItem* attack9 = MenuItemImage::create("equipment/wujinzhanren.jpg", "equipment/wujizhanren.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		...
		MenuItem* spell1 = MenuItemImage::create("equipment/zhoushudianji.jpg", "equipment/zhoushudianji.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell1->setScale(0.2f); spell1->setTag(11); spell1->setPosition(35 * winSize.width / 100, 65 * winSize.height / 100);

		MenuItem* spell2 = MenuItemImage::create("equipment/lanbaoshi.jpg", "equipment/lanbaoshi.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell2->setScale(0.2f); spell2->setTag(12); spell2->setPosition(45 * winSize.width / 100, 65 * winSize.height / 100);

		MenuItem* spell3 = MenuItemImage::create("equipment/yuansuzhang.jpg", "equipment/yuansuzhang.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell3->setScale(0.2f); spell3->setTag(13); spell3->setPosition(55 * winSize.width / 100, 65 * winSize.height / 100);

		MenuItem* spell4 = MenuItemImage::create("equipment/guanghuizhijian.jpg", "equipment/guanghuizhijian.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell4->setScale(0.2f); spell4->setTag(14); spell4->setPosition(35 * winSize.width / 100, 55 * winSize.height / 100);

		MenuItem* spell5 = MenuItemImage::create("equipment/jinhuashuijing.jpg", "equipment/jinhuashuijing.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell5->setScale(0.2f); spell5->setTag(15); spell5->setPosition(45 * winSize.width / 100, 55 * winSize.height / 100);

		MenuItem* spell6 = MenuItemImage::create("equipment/posuishengbei.jpg", "equipment/posuishengbei.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell6->setScale(0.2f); spell6->setTag(16); spell6->setPosition(55 * winSize.width / 100, 55 * winSize.height / 100);

		MenuItem* spell7 = MenuItemImage::create("equipment/xianzhezhishu.jpg", "equipment/xianzhezhishu.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell7->setScale(0.2f); spell7->setTag(17); spell7->setPosition(35 * winSize.width / 100, 45 * winSize.height / 100);

		MenuItem* spell8 = MenuItemImage::create("equipment/shengbei.jpg", "equipment/shengbei.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		spell8->setScale(0.2f); spell8->setTag(18); spell8->setPosition(45 * winSize.width / 100, 45 * winSize.height / 100);

		MenuItem* spell9 = MenuItemImage::create("equipment/boxuezhezhinu.jpg", "equipment/boxuezhezhinu.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		...
		MenuItem* defence1 = MenuItemImage::create("equipment/hongmanao.jpg", "equipment/hongmanao.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence1->setScale(0.2f); defence1->setTag(20); defence1->setPosition(35 * winSize.width / 100, 35 * winSize.height / 100);

		MenuItem* defence2 = MenuItemImage::create("equipment/bujia.jpg", "equipment/bujia.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence2->setScale(0.2f); defence2->setTag(21); defence2->setPosition(45 * winSize.width / 100, 35 * winSize.height / 100);

		MenuItem* defence3 = MenuItemImage::create("equipment/kangmopifeng.jpg", "equipment/kangmopifeng.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence3->setScale(0.2f); defence3->setTag(22); defence3->setPosition(55 * winSize.width / 100, 35 * winSize.height / 100);

		MenuItem* defence4 = MenuItemImage::create("equipment/liliangyaodai.jpg", "equipment/liliangyaodai.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence4->setScale(0.2f); defence4->setTag(23); defence4->setPosition(35 * winSize.width / 100, 25 * winSize.height / 100);

		MenuItem* defence5 = MenuItemImage::create("equipment/shenyindoupeng.jpg", "equipment/shenyindoupeng.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence5->setScale(0.2f); defence5->setTag(24); defence5->setPosition(45 * winSize.width / 100, 25 * winSize.height / 100);

		MenuItem* defence6 = MenuItemImage::create("equipment/xveshanyuandun.jpg", "equipment/xveshanyuandun.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence6->setScale(0.2f); defence6->setTag(25); defence6->setPosition(55 * winSize.width / 100, 25 * winSize.height / 100);

		MenuItem* defence7 = MenuItemImage::create("equipment/bazhezhongzhuang.jpg", "equipment/bazhezhongzhuang.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence7->setScale(0.2f); defence7->setTag(26); defence7->setPosition(35 * winSize.width / 100, 15 * winSize.height / 100);

		MenuItem* defence8 = MenuItemImage::create("equipment/buxiangzhengzhao.jpg", "equipment/buxiangzhengzhao.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		defence8->setScale(0.2f); defence8->setTag(27); defence8->setPosition(45 * winSize.width / 100, 15 * winSize.height / 100);

		MenuItem* defence9 = MenuItemImage::create("equipment/monvdoupeng.jpg", "equipment/monvdoupeng.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		...
		MenuItem* support1 = MenuItemImage::create("equipment/xveshibaoshi.jpg", "equipment/xveshibaoshi.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		support1->setScale(0.2f); support1->setTag(29); support1->setPosition(35 * winSize.width / 100, 5 * winSize.height / 100);

		MenuItem* support2 = MenuItemImage::create("equipment/fengmingzhihuan.jpg", "equipment/fengmingzhihuan.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
		support2->setScale(0.2f); support2->setTag(30); support2->setPosition(45 * winSize.width / 100, 5 * winSize.height / 100);

		MenuItem* support3 = MenuItemImage::create("equipment/jiying.jpg", "equipment/jiying.jpg", CC_CALLBACK_1(ShopLayer::shopMenuCallback, this));
